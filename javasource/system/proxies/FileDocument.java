...
public class FileDocument
{
	...
	{
		if (com.mendix.core.Core.isSubClassOf("GoogleDriveConnector.Doc", mendixObject.getType())) {
		...
		if (com.mendix.core.Core.isSubClassOf("GoogleDriveConnector.TestGoogleDrive", mendixObject.getType())) {
